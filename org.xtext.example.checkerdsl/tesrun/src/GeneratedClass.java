...
public class GeneratedClass {
  ...
  public ArrayList getM(final int idx1) {
    return (ArrayList)m.get(idx1);
  }
  
  public int getM(final int idx1, final int idx2) {
    ArrayList temp = (ArrayList)m.get(idx1);
    return (int)temp.get(idx2);
  }
  
  public void setM(final int idx1, final ArrayList val) {
    m.set(idx1,val);
  }
  
  public void setM(final int idx1, final int idx2, final Object val) {
    ArrayList temp = (ArrayList)m.get(idx1);
    temp.set(idx2,(int)val);
    m.set(idx1,temp);
  }
  
  public ArrayList getM_2(final int idx1) {
    return (ArrayList)m_2.get(idx1);
  }
  
  public int getM_2(final int idx1, final int idx2) {
    ArrayList temp = (ArrayList)m_2.get(idx1);
    return (int)temp.get(idx2);
  }
  
  public void setM_2(final int idx1, final ArrayList val) {
    m_2.set(idx1,val);
  }
  
  public void setM_2(final int idx1, final int idx2, final Object val) {
    ArrayList temp = (ArrayList)m_2.get(idx1);
    temp.set(idx2,(int)val);
    m_2.set(idx1,temp);
  }
  ...
  public void mr_followup_1() {
    ...
    ;
    m_2 = LibraryFunction.swapColumn(m,k,l);
    ;
  }
  ...
  public void mr_followup_3() {
    ...
    y_2 = y+1;
    ;
    m_2 = LibraryFunction.addColumn(m);
    ;
    for (int i=0; i<x; i++){
    setM_2(i,y,0);
    ;
  ...
  public void mr_followup_5() {
    ...
    int temp2 = getO(k1);
    ;
    setM_2(x,j,getM(temp,j)|getM(temp2,j));
    ;
    }
    numKey_2 = numKey+1;
    ;
  ...
  public void mr_followup_6() {
    ...
    int temp = getO(k);
    ;
    setM_2(1,j,getM(1,j)|getM(temp,j));
    ;
    }
    numKey_2 = numKey-1;
    ;
