...
* generated by Xtext
*/
package org.xtext.example.checkerdsl.ui.contentassist.antlr;
...
public class CheckerDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.example.checkerdsl.ui.contentassist.antlr.internal.InternalCheckerDslParser createParser() {
		org.xtext.example.checkerdsl.ui.contentassist.antlr.internal.InternalCheckerDslParser result = new org.xtext.example.checkerdsl.ui.contentassist.antlr.internal.InternalCheckerDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFollowUpAccess().getFollowupsAlternatives_2_0(), "rule__FollowUp__FollowupsAlternatives_2_0");
					put(grammarAccess.getPropertyAccess().getPropertiesAlternatives_2_0(), "rule__Property__PropertiesAlternatives_2_0");
					put(grammarAccess.getMRAccess().getMrExpAlternatives_3_0(), "rule__MR__MrExpAlternatives_3_0");
					put(grammarAccess.getChkTypeReferenceAccess().getAlternatives(), "rule__ChkTypeReference__Alternatives");
					...
					put(grammarAccess.getCheckAccess().getChkAlternatives_2_0(), "rule__Check__ChkAlternatives_2_0");
					put(grammarAccess.getFormatAccess().getAlternatives(), "rule__Format__Alternatives");
					put(grammarAccess.getMY_ELEMENTAccess().getAlternatives(), "rule__MY_ELEMENT__Alternatives");
					put(grammarAccess.getMY_NUMBERAccess().getAlternatives(), "rule__MY_NUMBER__Alternatives");
					...
					put(grammarAccess.getChkScoreExpressionAccess().getGroup(), "rule__ChkScoreExpression__Group__0");
					...
					put(grammarAccess.getMRAccess().getGroup(), "rule__MR__Group__0");
					put(grammarAccess.getChkVariableDeclarationAccess().getGroup(), "rule__ChkVariableDeclaration__Group__0");
					put(grammarAccess.getChkVariableDeclarationAccess().getGroup_1(), "rule__ChkVariableDeclaration__Group_1__0");
					put(grammarAccess.getChkVariableDeclarationAccess().getGroup_3(), "rule__ChkVariableDeclaration__Group_3__0");
					put(grammarAccess.getChkVariableDeclarationAccess().getGroup_3_2(), "rule__ChkVariableDeclaration__Group_3_2__0");
					put(grammarAccess.getChkVariableDeclarationAccess().getGroup_4(), "rule__ChkVariableDeclaration__Group_4__0");
					...
					put(grammarAccess.getChkPrefixAccess().getGroup(), "rule__ChkPrefix__Group__0");
					put(grammarAccess.getChkVariableAccess().getGroup(), "rule__ChkVariable__Group__0");
					put(grammarAccess.getChkVariableAccess().getGroup_3(), "rule__ChkVariable__Group_3__0");
					put(grammarAccess.getChkItemGroupAccess().getGroup(), "rule__ChkItemGroup__Group__0");
					put(grammarAccess.getChkItemGroupAccess().getGroup_2(), "rule__ChkItemGroup__Group_2__0");
					put(grammarAccess.getHelperAccess().getGroup_0(), "rule__Helper__Group_0__0");
					put(grammarAccess.getHelperAccess().getGroup_1(), "rule__Helper__Group_1__0");
					...
					put(grammarAccess.getHelperAccess().getGroup_5(), "rule__Helper__Group_5__0");
					...
					put(grammarAccess.getHelperAccess().getGroup_10(), "rule__Helper__Group_10__0");
					put(grammarAccess.getHelperAccess().getGroup_11(), "rule__Helper__Group_11__0");
					put(grammarAccess.getHelperAccess().getGroup_12(), "rule__Helper__Group_12__0");
					put(grammarAccess.getHelperAccess().getGroup_13(), "rule__Helper__Group_13__0");
					put(grammarAccess.getHelperAccess().getGroup_14(), "rule__Helper__Group_14__0");
					put(grammarAccess.getHelperAccess().getGroup_15(), "rule__Helper__Group_15__0");
					put(grammarAccess.getHelperAccess().getGroup_16(), "rule__Helper__Group_16__0");
					put(grammarAccess.getChkRelationalExpressionAccess().getGroup(), "rule__ChkRelationalExpression__Group__0");
					put(grammarAccess.getChkAssignmentAccess().getGroup(), "rule__ChkAssignment__Group__0");
					put(grammarAccess.getChkOperationAccess().getGroup(), "rule__ChkOperation__Group__0");
					put(grammarAccess.getChkOperationAccess().getGroup_1(), "rule__ChkOperation__Group_1__0");
					put(grammarAccess.getChkLoopExpressionAccess().getGroup(), "rule__ChkLoopExpression__Group__0");
					put(grammarAccess.getChkExpressionAccess().getGroup(), "rule__ChkExpression__Group__0");
					put(grammarAccess.getChkExpressionAccess().getGroup_0(), "rule__ChkExpression__Group_0__0");
					put(grammarAccess.getChkExpressionAccess().getGroup_3(), "rule__ChkExpression__Group_3__0");
					put(grammarAccess.getChkExpressionAccess().getGroup_3_2(), "rule__ChkExpression__Group_3_2__0");
					put(grammarAccess.getChkExpressionAccess().getGroup_4(), "rule__ChkExpression__Group_4__0");
					put(grammarAccess.getCheckAccess().getGroup(), "rule__Check__Group__0");
					put(grammarAccess.getSpValueAccess().getGroup(), "rule__SpValue__Group__0");
					put(grammarAccess.getSpValueAccess().getGroup_1(), "rule__SpValue__Group_1__0");
					...
					put(grammarAccess.getInputFormatAccess().getGroup(), "rule__InputFormat__Group__0");
					put(grammarAccess.getOutputFormatAccess().getGroup(), "rule__OutputFormat__Group__0");
					put(grammarAccess.getFormatExpressionAccess().getGroup(), "rule__FormatExpression__Group__0");
					put(grammarAccess.getFormatExpressionAccess().getGroup_2(), "rule__FormatExpression__Group_2__0");
					put(grammarAccess.getFormatExpressionAccess().getGroup_2_1(), "rule__FormatExpression__Group_2_1__0");
					put(grammarAccess.getFormatExpressionAccess().getGroup_2_2(), "rule__FormatExpression__Group_2_2__0");
					put(grammarAccess.getFormatExpressionAccess().getGroup_2_2_2(), "rule__FormatExpression__Group_2_2_2__0");
					put(grammarAccess.getCHK_INTAccess().getGroup(), "rule__CHK_INT__Group__0");
					...
					put(grammarAccess.getDslAccess().getImportSectionAssignment_0(), "rule__Dsl__ImportSectionAssignment_0");
					put(grammarAccess.getDslAccess().getElementsAssignment_1(), "rule__Dsl__ElementsAssignment_1");
					...
					put(grammarAccess.getClassAccess().getFeaturesAssignment_4(), "rule__Class__FeaturesAssignment_4");
					...
					put(grammarAccess.getChkScoreExpressionAccess().getSubtaskAssignment_1(), "rule__ChkScoreExpression__SubtaskAssignment_1");
					put(grammarAccess.getChkScoreExpressionAccess().getScoreAssignment_3(), "rule__ChkScoreExpression__ScoreAssignment_3");
					put(grammarAccess.getScoreAccess().getScoresAssignment_2(), "rule__Score__ScoresAssignment_2");
					put(grammarAccess.getFollowUpAccess().getFolAssignment_0(), "rule__FollowUp__FolAssignment_0");
					put(grammarAccess.getFollowUpAccess().getFollowupsAssignment_2(), "rule__FollowUp__FollowupsAssignment_2");
					put(grammarAccess.getPropertyAccess().getPropAssignment_0(), "rule__Property__PropAssignment_0");
					put(grammarAccess.getPropertyAccess().getPropertiesAssignment_2(), "rule__Property__PropertiesAssignment_2");
					put(grammarAccess.getMRAccess().getMrAssignment_0(), "rule__MR__MrAssignment_0");
					put(grammarAccess.getMRAccess().getNumAssignment_1(), "rule__MR__NumAssignment_1");
					put(grammarAccess.getMRAccess().getMrExpAssignment_3(), "rule__MR__MrExpAssignment_3");
					put(grammarAccess.getMRAccess().getFollowupAssignment_4(), "rule__MR__FollowupAssignment_4");
					put(grammarAccess.getMRAccess().getPropertyAssignment_5(), "rule__MR__PropertyAssignment_5");
					...
					put(grammarAccess.getMethodCallAccess().getParamsAssignment_2_0(), "rule__MethodCall__ParamsAssignment_2_0");
					put(grammarAccess.getMethodCallAccess().getParamsAssignment_2_1_1(), "rule__MethodCall__ParamsAssignment_2_1_1");
					put(grammarAccess.getChkPrefixAccess().getTypeAssignment_0(), "rule__ChkPrefix__TypeAssignment_0");
					put(grammarAccess.getChkVariableAccess().getPrefAssignment_0(), "rule__ChkVariable__PrefAssignment_0");
					put(grammarAccess.getChkVariableAccess().getVarAssignment_1(), "rule__ChkVariable__VarAssignment_1");
					put(grammarAccess.getChkVariableAccess().getNewtestAssignment_2(), "rule__ChkVariable__NewtestAssignment_2");
					put(grammarAccess.getChkVariableAccess().getVAssignment_3_1(), "rule__ChkVariable__VAssignment_3_1");
					put(grammarAccess.getChkVariablesAccess().getVaAssignment_0(), "rule__ChkVariables__VaAssignment_0");
					put(grammarAccess.getChkVariablesAccess().getNuAssignment_1(), "rule__ChkVariables__NuAssignment_1");
					put(grammarAccess.getChkVariablesAccess().getGrAssignment_2(), "rule__ChkVariables__GrAssignment_2");
					put(grammarAccess.getChkItemGroupAccess().getVarsAssignment_1(), "rule__ChkItemGroup__VarsAssignment_1");
					put(grammarAccess.getChkItemGroupAccess().getVarsAssignment_2_1(), "rule__ChkItemGroup__VarsAssignment_2_1");
					put(grammarAccess.getHelperAccess().getSumAssignment_0_0(), "rule__Helper__SumAssignment_0_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_0_2(), "rule__Helper__VarAssignment_0_2");
					put(grammarAccess.getHelperAccess().getMaxAssignment_1_0(), "rule__Helper__MaxAssignment_1_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_1_2(), "rule__Helper__VarAssignment_1_2");
					...
					put(grammarAccess.getHelperAccess().getVar2Assignment_4_6(), "rule__Helper__Var2Assignment_4_6");
					put(grammarAccess.getHelperAccess().getSelectAssignment_5_0(), "rule__Helper__SelectAssignment_5_0");
					put(grammarAccess.getHelperAccess().getVarsAssignment_5_2(), "rule__Helper__VarsAssignment_5_2");
					put(grammarAccess.getHelperAccess().getVarsAssignment_5_3_1(), "rule__Helper__VarsAssignment_5_3_1");
					put(grammarAccess.getHelperAccess().getAddAssignment_6_0(), "rule__Helper__AddAssignment_6_0");
					...
					put(grammarAccess.getHelperAccess().getSizeAssignment_9_0(), "rule__Helper__SizeAssignment_9_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_9_2(), "rule__Helper__VarAssignment_9_2");
					put(grammarAccess.getHelperAccess().getPermuteAssignment_10_0(), "rule__Helper__PermuteAssignment_10_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_10_2(), "rule__Helper__VarAssignment_10_2");
					put(grammarAccess.getHelperAccess().getPlusAssignment_11_0(), "rule__Helper__PlusAssignment_11_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_11_2(), "rule__Helper__VarAssignment_11_2");
					put(grammarAccess.getHelperAccess().getVar3Assignment_11_4(), "rule__Helper__Var3Assignment_11_4");
					put(grammarAccess.getHelperAccess().getMultiplyAssignment_12_0(), "rule__Helper__MultiplyAssignment_12_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_12_2(), "rule__Helper__VarAssignment_12_2");
					put(grammarAccess.getHelperAccess().getVar3Assignment_12_4(), "rule__Helper__Var3Assignment_12_4");
					put(grammarAccess.getHelperAccess().getInvertAssignment_13_0(), "rule__Helper__InvertAssignment_13_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_13_2(), "rule__Helper__VarAssignment_13_2");
					put(grammarAccess.getHelperAccess().getIncludeAssignment_14_0(), "rule__Helper__IncludeAssignment_14_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_14_2(), "rule__Helper__VarAssignment_14_2");
					put(grammarAccess.getHelperAccess().getVar3Assignment_14_4(), "rule__Helper__Var3Assignment_14_4");
					put(grammarAccess.getHelperAccess().getExcludeAssignment_15_0(), "rule__Helper__ExcludeAssignment_15_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_15_2(), "rule__Helper__VarAssignment_15_2");
					put(grammarAccess.getHelperAccess().getVar3Assignment_15_4(), "rule__Helper__Var3Assignment_15_4");
					put(grammarAccess.getHelperAccess().getCompositionalAssignment_16_0(), "rule__Helper__CompositionalAssignment_16_0");
					put(grammarAccess.getHelperAccess().getVarAssignment_16_2(), "rule__Helper__VarAssignment_16_2");
					put(grammarAccess.getChkRelationalExpressionAccess().getV1Assignment_0(), "rule__ChkRelationalExpression__V1Assignment_0");
					put(grammarAccess.getChkRelationalExpressionAccess().getOprAssignment_1(), "rule__ChkRelationalExpression__OprAssignment_1");
					put(grammarAccess.getChkRelationalExpressionAccess().getV2Assignment_2(), "rule__ChkRelationalExpression__V2Assignment_2");
					put(grammarAccess.getChkAssignmentAccess().getV1Assignment_0(), "rule__ChkAssignment__V1Assignment_0");
					put(grammarAccess.getChkAssignmentAccess().getOprAssignment_1(), "rule__ChkAssignment__OprAssignment_1");
					put(grammarAccess.getChkAssignmentAccess().getV2Assignment_2(), "rule__ChkAssignment__V2Assignment_2");
					put(grammarAccess.getChkOperationAccess().getOperandAssignment_0(), "rule__ChkOperation__OperandAssignment_0");
					put(grammarAccess.getChkOperationAccess().getOperatorAssignment_1_0(), "rule__ChkOperation__OperatorAssignment_1_0");
					put(grammarAccess.getChkOperationAccess().getOperandAssignment_1_1(), "rule__ChkOperation__OperandAssignment_1_1");
					put(grammarAccess.getChkLoopExpressionAccess().getIndexAssignment_2(), "rule__ChkLoopExpression__IndexAssignment_2");
					put(grammarAccess.getChkLoopExpressionAccess().getMaxIndexAssignment_4(), "rule__ChkLoopExpression__MaxIndexAssignment_4");
					put(grammarAccess.getChkLoopExpressionAccess().getExAssignment_7(), "rule__ChkLoopExpression__ExAssignment_7");
					put(grammarAccess.getChkExpressionAccess().getAsgAssignment_0_1(), "rule__ChkExpression__AsgAssignment_0_1");
					put(grammarAccess.getChkExpressionAccess().getExpAssignment_2(), "rule__ChkExpression__ExpAssignment_2");
					put(grammarAccess.getChkExpressionAccess().getWhereAssignment_3_0(), "rule__ChkExpression__WhereAssignment_3_0");
					put(grammarAccess.getChkExpressionAccess().getCondAssignment_3_1(), "rule__ChkExpression__CondAssignment_3_1");
					put(grammarAccess.getChkExpressionAccess().getTypeAssignment_3_2_0(), "rule__ChkExpression__TypeAssignment_3_2_0");
					put(grammarAccess.getChkExpressionAccess().getCondAssignment_3_2_1(), "rule__ChkExpression__CondAssignment_3_2_1");
					put(grammarAccess.getChkExpressionAccess().getOpAssignment_4_0(), "rule__ChkExpression__OpAssignment_4_0");
					put(grammarAccess.getChkExpressionAccess().getVAssignment_4_1(), "rule__ChkExpression__VAssignment_4_1");
					put(grammarAccess.getCheckAccess().getCheckAssignment_0(), "rule__Check__CheckAssignment_0");
					put(grammarAccess.getCheckAccess().getChkAssignment_2(), "rule__Check__ChkAssignment_2");
					put(grammarAccess.getSpValueAccess().getValAssignment_0(), "rule__SpValue__ValAssignment_0");
					put(grammarAccess.getSpValueAccess().getValAssignment_1_1(), "rule__SpValue__ValAssignment_1_1");
					put(grammarAccess.getLimitAccess().getSubAssignment_0(), "rule__Limit__SubAssignment_0");
					put(grammarAccess.getLimitAccess().getAAssignment_1(), "rule__Limit__AAssignment_1");
					put(grammarAccess.getLimitAccess().getBAssignment_3(), "rule__Limit__BAssignment_3");
					put(grammarAccess.getLimitAccess().getAAssignment_4_1(), "rule__Limit__AAssignment_4_1");
					put(grammarAccess.getLimitAccess().getBAssignment_4_3(), "rule__Limit__BAssignment_4_3");
					put(grammarAccess.getSubtaskAccess().getNumAssignment_1(), "rule__Subtask__NumAssignment_1");
					put(grammarAccess.getInputFormatAccess().getInputAssignment_0(), "rule__InputFormat__InputAssignment_0");
					put(grammarAccess.getInputFormatAccess().getExpAssignment_2(), "rule__InputFormat__ExpAssignment_2");
					put(grammarAccess.getOutputFormatAccess().getOutputAssignment_0(), "rule__OutputFormat__OutputAssignment_0");
					put(grammarAccess.getOutputFormatAccess().getExpAssignment_2(), "rule__OutputFormat__ExpAssignment_2");
					put(grammarAccess.getFormatExpressionAccess().getNumAssignment_0(), "rule__FormatExpression__NumAssignment_0");
					put(grammarAccess.getFormatExpressionAccess().getVarAssignment_2_0(), "rule__FormatExpression__VarAssignment_2_0");
					put(grammarAccess.getFormatExpressionAccess().getCountAssignment_2_1_1(), "rule__FormatExpression__CountAssignment_2_1_1");
					put(grammarAccess.getFormatExpressionAccess().getVarAssignment_2_2_1(), "rule__FormatExpression__VarAssignment_2_2_1");
					put(grammarAccess.getFormatExpressionAccess().getCountAssignment_2_2_2_1(), "rule__FormatExpression__CountAssignment_2_2_2_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.example.checkerdsl.ui.contentassist.antlr.internal.InternalCheckerDslParser typedParser = (org.xtext.example.checkerdsl.ui.contentassist.antlr.internal.InternalCheckerDslParser) parser;
